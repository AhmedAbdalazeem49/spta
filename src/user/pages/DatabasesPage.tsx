...
const DatabasesPage = () => {
  ...
  const categories = [
    ...
    {
      id: "bibliographic",
      label: t("القواعد الببليوغرافية", "Bibliographic Databases"),
      icon: BookOpen,
    },
    {
      id: "guidelines",
      label: t("الإرشادات السريرية", "Clinical Guidelines"),
      icon: FileText,
    },
    {
      id: "rehabilitation",
      label: t("قواعد التأهيل", "Rehabilitation Databases"),
      icon: Heart,
    },
  ];
  ...
  const databases: DatabaseItem[] = [
    {
      ...
      description:
        "قاعدة بيانات المكتبة الوطنية الأمريكية للطب، تحتوي على أكثر من 35 مليون مرجع في العلوم الطبية والحيوية",
      descriptionEn:
        "US National Library of Medicine database with over 35 million references in biomedical sciences",
    ...
    },
    {
      ...
      description:
        "مجموعة من قواعد البيانات تحتوي على مراجعات منهجية عالية الجودة للأدلة في الرعاية الصحية",
      descriptionEn:
        "Collection of databases containing high-quality systematic reviews of evidence in healthcare",
      category: "guidelines",
    ...
    },
    {
      ...
      nameEn: "PEDro",
      description:
        "قاعدة بيانات الأدلة في العلاج الطبيعي، تحتوي على تجارب عشوائية ومراجعات منهجية وإرشادات",
      descriptionEn:
        "Physiotherapy Evidence Database containing randomized trials, systematic reviews, and guidelines",
    ...
    },
    {
      ...
      descriptionEn:
        "Comprehensive database for nursing and allied health sciences",
      category: "bibliographic",
      categoryEn: "Bibliographic",
    ...
    },
    {
      ...
      nameEn: "Embase",
      description:
        "قاعدة بيانات طبية حيوية من Elsevier تركز على الأدوية والصيدلة",
      descriptionEn:
        "Biomedical database from Elsevier focusing on drugs and pharmacology",
      category: "bibliographic",
      categoryEn: "Bibliographic",
    ...
    },
    {
      ...
      description:
        "إرشادات المعهد الوطني للتميز في الرعاية الصحية في المملكة المتحدة",
      descriptionEn:
        "National Institute for Health and Care Excellence guidelines from the UK",
      category: "guidelines",
      categoryEn: "Guidelines",
    ...
    },
    {
      ...
      description:
        "شبكة الإرشادات الاسكتلندية للتوصيات السريرية المبنية على الأدلة",
      descriptionEn:
        "Scottish Intercollegiate Guidelines Network for evidence-based clinical recommendations",
      category: "guidelines",
      categoryEn: "Guidelines",
    ...
    },
    {
      ...
      description:
        "قاعدة بيانات لأدوات القياس في إعادة التأهيل مع معلومات السيكومتري",
      descriptionEn:
        "Database of rehabilitation measurement instruments with psychometric information",
      category: "rehabilitation",
      categoryEn: "Rehabilitation",
      coverage: "شامل",
    ...
    },
    {
      ...
      descriptionEn:
        "Clinical evidence search engine that searches across multiple sources",
      category: "bibliographic",
      categoryEn: "Bibliographic",
    ...
    },
    {
      ...
      nameEn: "ERIC",
      description:
        "مركز معلومات الموارد التعليمية - قاعدة بيانات للأبحاث التعليمية",
      descriptionEn:
        "Education Resources Information Center - database for educational research",
      category: "bibliographic",
      categoryEn: "Bibliographic",
  ...
  const filteredDatabases = databases.filter((db) => {
    const matchesCategory =
      activeCategory === "all" || db.category === activeCategory;
    const matchesSearch =
      searchQuery === "" ||
                      ...
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span
                          className={`text-xs px-2 py-1 rounded-full ${
                            db.category === "bibliographic"
                              ? "bg-blue-pale text-blue-primary"
                              : db.category === "guidelines"
