...
export const WorkshopsTable = ({
  ...
  const [qrWorkshop, setQrWorkshop] = useState<Workshop | null>(null);
  ...
  return (
    <>
                ...
                <td className="p-4">
                  <div className="flex items-center gap-1">
                    ...
                    <Button
                      ...
                      onClick={() => setQrWorkshop(w)}
                      title={t("رمز QR للحضور", "Attendance QR")}
                    >
      ...
      {/* QR Modal */}
      <WorkshopAttendanceQR
        workshop={qrWorkshop}
        open={!!qrWorkshop}
        onClose={() => setQrWorkshop(null)}
      />
    </>
  );
};
