        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              <p className="font-semibold">{t('حمل التطبيق', 'Download the App')}</p>
          ...
          {/* About Links */}
          <div>
            <h3 className="font-bold text-lg mb-6">{t('من نحن', 'About Us')}</h3>
          ...
          {/* Research Links */}
          <div>
            <h3 className="font-bold text-lg mb-6">{t('البحث والتعليم', 'Research')}</h3>
            <ul className="space-y-3">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+966" className="text-primary-foreground/80 hover:text-primary-foreground">
                  +966 XX XXX XXXX
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-5 h-5 flex-shrink-0" />
                <a href="mailto:info@spta.org.sa" className="text-primary-foreground/80 hover:text-primary-foreground">
                  info@spta.org.sa
                </a>
              </li>
            </ul>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6 text-sm">
              ...
              <Link to="/terms" className="text-primary-foreground/60 hover:text-primary-foreground">
                {t('الشروط والأحكام', 'Terms of Use')}
              </Link>
            </div>
          </div>
        </div>
